...
trait YandexMethods
{
    ...
    /**
     * Справочник регионов: ищет код региона (lr) по названию города или
     * области. Бесплатно, но ключ обязателен — по нему считается лимит.
     *
     ...
     * Стоимость: 0.01 ₽ за страницу.
     *
     * Общие фильтры (size, orientation, color, type, format, freshness, site)
     * переводятся в родные параметры Яндекса. Значение, которого у Яндекса
     * нет, возвращает 422 с указанием, чем его заменить.
     *
     * @param string|array{
     *     q: string,
     *     pages?: int,
